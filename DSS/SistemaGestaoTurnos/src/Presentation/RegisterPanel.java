...
public class RegisterPanel extends javax.swing.JPanel {
    ...
    public RegisterPanel(BusinessFacade bFacade) {
    ...
    private void registerButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerButtonMouseClicked
        ...
        if (!pass.equals(confirm)) {
            ...
            try {
                u = bFacade.registar(userTextField.getText(), pass);

                if (u instanceof Aluno) {
                    StudentPage s = new StudentPage(bFacade);
                    s.setVisible(true);
                    SwingUtilities.windowForComponent(this).dispose();
                } else if (u instanceof Docente) {
                    TeacherPage t = new TeacherPage(bFacade);
                    t.setVisible(true);
                    SwingUtilities.windowForComponent(this).dispose();
                } else if (u instanceof DirecaoCurso) {
                    DCPage d = new DCPage(bFacade);
                    d.setVisible(true);
                    SwingUtilities.windowForComponent(this).dispose();
                }
