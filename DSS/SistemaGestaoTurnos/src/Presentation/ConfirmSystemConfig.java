 ...
 * @author rafae
 */
public class ConfirmSystemConfig extends javax.swing.JFrame {

    private static final String CONFIG_FILE = "config.txt";
    private static final String CLASSES_STARTED = "started=0";
    ...
    public ConfirmSystemConfig(BusinessFacade bFacade, File file) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ao configurar o sistema todos os dados");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jLabel2.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("serão eliminados. Pretende continuar?");
    ...
    private void yesButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_yesButtonMouseClicked
        if (file != null) {
            try {
                bFacade.configurar();
                Parser parser = new Parser(bFacade, file);
                ...
                if (b) {
                    ...
                    ErrorMessage error = 
                            new ErrorMessage("Erro ao configurar o sistema...");
                    error.setVisible(true);
                }
            } catch (IOException | UtilizadorInvalido e) {
                throw new RuntimeException(e);
            }
        } else {
            ErrorMessage error = 
                    new ErrorMessage("Nenhum ficheiro selecionado!");
            error.setVisible(true);
        }
