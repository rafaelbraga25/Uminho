...
Ficheiros xml:
	...
	solarSystem.xml - Representa um modelo do sistema solar (sol, planetas e lua da terra, cintura de asteróides
	                          e um cometa com a forma de um teapot).
	teapot.xml - Representa um modelo com um teapot (tesselagem = 5).
